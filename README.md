...
|webi_k9s.sh         |Installs K9s using webi                           |Kubernetes tasks (using dnf)
|webi_k9s_krew.sh    |Install k9s using webi, ctx and ns using krew     |Kuberneses tasks (using apt)
